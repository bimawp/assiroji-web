    ...
    <div>
      <div className="flex w-full justify-between items-center border-b border-[#1D564F] pb-4">
        <div className="w-[400px] relative flex items-center border  px-3 border-[#1D564F]">
          <input type="search" className=" w-full outline-none py-2" placeholder="Search artikel" />
      ...
      <div className="w-full py-4">
          ...
          <table className="w-full border-collapse ">
            ...
            <thead>
              <tr className="bg-[#039786] ">
                ...
                <th className="px-6 py-4 text-left text-sm font-medium text-white">Content type</th>
            ...
            {/* Table Body */}
            <tbody className="divide-y bg-gray-200  divide-gray-100">
              {/* Loading State Rows */}
              {[1, 2, 3].map((index) => (
        ...
        <div className="mt-4 flex justify-end gap-2">
          <button className="rounded bg-[#039786] p-2 text-white hover:bg-emerald-600">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
